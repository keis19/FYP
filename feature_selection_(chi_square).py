# -*- coding: utf-8 -*-
"""Feature Selection (Chi Square).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/116G85GIZorw2fXJHVd08KjH6gp4474fV
"""
...
features = ['credit_card_number', 'merchant', 'category',
       'amount(usd)', 'city_pop', 'job', 'transaction_id','hour_of_day']
       
#remove 'zip', 'unix_time', 'merch_lat', 'merch_long', 'lat', 'long'
...
top_5_features = p_values.index[:5]
...
print('Decision Tree - CHI SQUARE')
...
#Decision Tree with SMOTE & RUS
dtree.fit(X_train_smote_rus, y_train_smote_rus)
y_pred = dtree.predict(X_test)
print(classification_report(y_test,y_pred))
...
plt.plot(recall, precision)
fig1=plt.title('DTC with SMOTE + RUS')
fig1=plt.show()
fig1
...
print('Random Forest Classifier -Standard')
...
print ('Random Forest Classifier - SMOTE + RUS')
rf_random = RandomForestClassifier()
rf_random.fit(X_train_smote_rus, y_train_smote_rus)
y_pred = rf_random.predict(X_test)
print(classification_report(y_test, y_pred))
...
XG_random = GradientBoostingClassifier()
XG_random.fit(X_train_smote_rus, y_train_smote_rus)
y_pred = XG_random.predict(X_test)
print(classification_report(y_test, y_pred))
...
KNC= KNeighborsClassifier()
KNC.fit(X_train_smote_rus, y_train_smote_rus)
y_pred = KNC.predict(X_test)
print(classification_report(y_test,y_pred))
